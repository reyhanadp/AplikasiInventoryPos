 ...
 * @author Operator
 */
public class DialogTambahPemesanan_1 extends javax.swing.JDialog {
    ...
    public DialogTambahPemesanan_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogTambahPemesanan_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogTambahPemesanan_1 dialog = new DialogTambahPemesanan_1(new javax.swing.JFrame(), true);
