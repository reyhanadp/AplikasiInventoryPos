 ...
 * @author reyha
 */
public class DialogViewDetailPemesanan extends javax.swing.JDialog {

    /**
     * Creates new form DialogViewDetailPemesanan
     */
    public DialogViewDetailPemesanan(java.awt.Frame parent, boolean modal) {

    }

    public DialogViewDetailPemesanan(FormHome formHome, boolean b, String id_pemesanan) {
        super(formHome, b);
        initComponents();
        setLocationRelativeTo(this);
        PemesananDAO dao = new PemesananDAOImpl();
        Vector vectorViewDetailPemesanan = new Vector();
        vectorViewDetailPemesanan = dao.getViewDetailPemesanan(id_pemesanan);
        labelIdPemesanan.setText(id_pemesanan);
        labelNoPemesanan.setText((String) vectorViewDetailPemesanan.get(0));
        DateFormat df = new SimpleDateFormat("dd-MM-yyyy");
        labelTglPemesanan.setText(df.format(vectorViewDetailPemesanan.get(1)));
        labelJumlahPemesanan.setText(format_titik((String) vectorViewDetailPemesanan.get(2)));
        labelStatus.setText((String) vectorViewDetailPemesanan.get(3));
        labelIdProduk.setText((String) vectorViewDetailPemesanan.get(4));
        labelNamaProduk.setText((String) vectorViewDetailPemesanan.get(5));
        labelNominal.setText(format_titik((String) vectorViewDetailPemesanan.get(6)));
        String biaya_cetak = String.valueOf(Float.parseFloat((String) vectorViewDetailPemesanan.get(7))).replace(".", ",");
        ...
        labelStok.setText(format_titik((String) vectorViewDetailPemesanan.get(8)));
        labelTahun.setText((String) vectorViewDetailPemesanan.get(9));
        labelIdMitra.setText((String) vectorViewDetailPemesanan.get(10));
        labelNamaMitra.setText((String) vectorViewDetailPemesanan.get(11));
        labelAlamat.setText((String) vectorViewDetailPemesanan.get(12));
        labelNomorTelp.setText((String) vectorViewDetailPemesanan.get(13));
    ...
    private void initComponents() {
        ...
        labelTglPemesanan = new javax.swing.JLabel();
        labelJumlahPemesanan = new javax.swing.JLabel();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("View Detail Pemesanan"));
        ...
        labelIdPemesanan.setText("jLabel23");

        labelNoPemesanan.setText("jLabel24");

        labelTglPemesanan.setText("jLabel25");

        labelJumlahPemesanan.setText("jLabel26");

        labelStatus.setText("jLabel27");

        labelIdProduk.setText("jLabel28");

        labelNamaProduk.setText("jLabel29");

        labelNominal.setText("jLabel30");

        labelBiayaCetak.setText("jLabel31");

        labelStok.setText("jLabel32");

        labelTahun.setText("jLabel33");

        labelIdMitra.setText("jLabel34");

        labelNamaMitra.setText("jLabel35");

        labelAlamat.setText("jLabel36");

        labelNomorTelp.setText("jLabel37");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(labelTglPemesanan))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel11)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(labelJumlahPemesanan))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogViewDetailPemesanan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogViewDetailPemesanan dialog = new DialogViewDetailPemesanan(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JLabel labelJumlahPemesanan;
    ...
    private javax.swing.JLabel labelTglPemesanan;
