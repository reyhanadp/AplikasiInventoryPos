...
insert  into `tb_hapus_produk`(`id_produk`,`nama_produk`,`nominal`,`biaya_cetak`,`stok`,`tahun`,`id_jenis_produk`,`tgl_penghapusan`) values ('PR001','prangko 1',10,20,10,2010,'PR','2017-08-21 14:11:21'),('KM001','kemasan 1',10,20,10,2000,'KM','2017-08-21 14:11:21'),('',NULL,NULL,NULL,NULL,NULL,NULL,'2017-08-21 14:16:10'),('PR002','prangko 2',100,20,10,2010,'PR','2017-08-21 14:19:05');
...
insert  into `tb_jenis_produk`(`id_jenis_produk`,`nama_jenis_produk`) values ('DF','Dokumen Filateli'),('KM','Kemasan'),('MC','Merchandise'),('MS','MS'),('PR','Prangko'),('PS','Prisma'),('SH','SHP'),('SP','SHPSS'),('SS','SS');
...
insert  into `tb_produk`(`id_produk`,`nama_produk`,`nominal`,`biaya_cetak`,`stok`,`tahun`,`id_jenis_produk`) values ('PR003','prangko 3',1500,200,10,2011,'PR');
...
insert  into `tb_update_produk`(`id_produk`,`nama_produk`,`nominal`,`biaya_cetak`,`stok`,`tahun`,`id_jenis_produk`,`tgl_update`) values ('PR003','prangko 3',1000,200,10,2011,'PR','2017-08-21 14:23:37');
