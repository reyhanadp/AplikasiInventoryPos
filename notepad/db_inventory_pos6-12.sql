...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2017 at 02:57 PM
...
('KM001', 'kemasan 1', 10, 20, 10, 2000, 'KM', '2017-08-21 00:11:21'),
('PR001', 'prangko 1', 10, 20, 10, 2010, 'PR', '2017-08-21 00:11:21'),
('PR002', 'prangko 2', 100, 20, 10, 2010, 'PR', '2017-08-21 00:19:05'),
...
('SHP001', NULL, NULL, NULL, NULL, NULL, NULL, '2017-08-24 21:06:17');
...
INSERT INTO `tb_user` (`username`, `password`, `nama_user`, `nik`, `hak_akses`) VALUES
('amad', 'amad', 'amad', '111', 'fl');
...
ALTER TABLE `tb_trans_pengiriman`
  ADD PRIMARY KEY (`no_order_pengiriman`),
